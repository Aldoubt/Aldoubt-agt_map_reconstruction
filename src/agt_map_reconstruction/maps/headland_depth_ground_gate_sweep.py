...
def sweep_headland_depth_ground_gate(
    ...
    *,
    ...
    return {
        ...
        "uncertainty_quantile": payload.get("uncertainty_quantile"),
        "depth_edges_m": [float(value) for value in payload.get("depth_edges_m", [])],
        "max_outward_depth_m": payload.get("max_outward_depth_m"),
        "unresolved_ridge_ids": list(payload.get("unresolved_ridge_ids") or []),
